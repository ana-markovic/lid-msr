...
//        master.setIteration(i + 1);
        ...
        master.repoInputFile = "experiment/techrank/in/" + jobConf + ".csv";
        master.setWorkerConf(workerConf);
        master.setWorkerCount(NUMBER_OF_WORKERS);
