...
public class CrossflowMetrics implements Serializable {
    ...
    public static String CSV_HEADER = "repositoryName,repositorySizeBytes,cacheMiss,bytesLoaded,workerId,downloadDuration,ioProcessingDuration,jobStartTime,currentLatency";
