...
public class HistoryTechrankWorkflowExt extends HistoryTechrankWorkflow {
    ...
    private final List<Double> correctionFactors = new ArrayList<>();

    private final List<Double> localCorrectionFactors = new ArrayList<>();
    private final List<Double> nonLocalCorrectionFactors = new ArrayList<>();
    private long workflowStartTime;

    private final List<Long> netSpeed = new ArrayList<>();
    private final List<Long> ioSpeeds = new ArrayList<>();

    public Map<String, Long> repoSizes = new HashMap<>();
    private final Map<String, Integer> netSleepTime = new HashMap<>();
    private final Map<String, Integer> ioSleepTime = new HashMap<>();
    private final Map<String, Integer> lineCounts = new HashMap<>();

    private LinearRegression myLinearRegression = null;

    private final List<LinRegPoint> linRegPoints = new ArrayList<>();
    ...
    private static final String REPO_CSV = "repositories.csv";


    public HistoryTechrankWorkflowExt(Mode m) {
        super(m);
        algorithm = System.getenv().getOrDefault("CF_TYPE", "LIN_REG");
